...
class DemoList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: "VxDemo_Home_Navigation".text.make(),
      ),
      body: VStack([
        ExpansionTile(
          ...
          children: [
            TextButton(
                onPressed: () {
                  // context.vxNav.push(
                  //     Uri(path: "/nav/path123", queryParameters: {"": ""}));
            ...
            TextButton(
              ...
              child: "Push Page Nav1".text.make(),
            ),
            TextButton(
              onPressed: () {
            ...
            TextButton(
              onPressed: () async {
                ...
                print("---> wait Returned path value: $path");
              },
        ...
        ExpansionTile(
          ...
          childrenPadding: Vx.m64,
          children: [
            VStack(
              [
                "stack1".text.make(),
                HeightBox(10),
                "stack2".text.color(Colors.red).size(30).bold.make()
              ],
