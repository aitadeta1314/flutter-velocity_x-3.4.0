import 'package:example/examples/animated_box_example.dart';
...
class _DemoState extends State<Demo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: VxAppBar(
        searchBar: true,
        title: "Vx Demo Navigation".text.make(),
      ),
      body: VStack([
        PlatformBar(),
        HeightBox(20),
        ...
        "Hello"
          ...
          // Show Toast
          // context.showToast(
          //     msg: "Hello Vx, I am a toast.",
          //     bgColor: Colors.purple[400],
          //     position: VxToastPosition.top);
          // VxToast.showLoading(context, msg: "Loading", textColor: Colors.white);
